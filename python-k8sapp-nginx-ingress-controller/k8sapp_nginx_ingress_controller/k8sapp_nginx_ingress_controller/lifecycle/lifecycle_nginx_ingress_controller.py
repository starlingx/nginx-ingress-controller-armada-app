...
class NginxIngressControllerAppLifecycleOperator(base.AppLifecycleOperator):
    def app_lifecycle_actions(self, context, conductor_obj, app_op, app, hook_info):
        ...
        """
        LOG.info("Executing app_lifecycle_actions for {} app: {}".format(constants.HELM_APP_NGINX_IC, hook_info))
    ...
    def pre_apply(self, app):
        """Pre Apply actions

        Migrates helm user overrides from one chart name to another

        :param app: AppOperator.Application object

        """
        LOG.info("Executing pre_apply for {} app".format(constants.HELM_APP_NGINX_IC))
